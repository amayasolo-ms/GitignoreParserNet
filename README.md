...
You can find the Nuget Pachage [here](https://www.nuget.org/packages/GitignoreParserNet/0.2.0.10), or just:

`Install-Package GitignoreParserNet -Version 0.2.0.10`
